...
The application SHALL display a full-screen “On Her Way” landing screen on initial load, before showing the existing home screen.
...
#### Scenario: User starts exploring
